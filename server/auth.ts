...
export function setupAuth(app: Express) {
  ...
  passport.use(
    new LocalStrategy(async (username, password, done) => {
      ...
      // In a real app, we would hash. 
      // Checking both for robustness in this demo environment.
      if (user.password === password) {
         return done(null, user);
      }

      // If we were using hashing (which we should for new users created via register)
